...
contract('GameRound test cases', function(accounts) {
    ...
    function assertEqualMove(move, side, isSecret, moveData) {
        assert.deepEqual(
            [move[0].toNumber(), move[1], move[2].toNumber()],
            [side, isSecret, moveData]);
    }
    ...
    it("players play with secret moves", async function () {
        ...
        assertEqualMove(await round.getMove.call(0), 1, true, 0);
        ...
        assertEqualMove(await round.getMove.call(1), 2, true, 0);
